...
const pubnub = new Pubnub({
    publishKey: 'pub-c-bbeb8b59-fbb2-4802-bc34-2d325a9e5a5d',
    subscribeKey: 'sub-c-8559623e-c7af-40ef-b16f-932345383074',
    secretKey: 'sec-c-MGUzMjNlNjAtZWE3YS00MTNlLWI2Y2UtMGU4ZTc1YjAxMTY1',
    userId: `${Date.now()}`,
}) 
